                  ...
                  , W = function() {
                    ...
                    void 0 !== l)
                        if (y(l))
                            ...
                            D(h, "string" == typeof l ? "?" === l.charAt(0) ? l.slice(1) : l : l + "")
                }
                  , H = W.prototype;
                u(H, {
                    append: function(e, t) {
        ...
        return function() {
            ...
            var b = function(e) {
                ...
                function i(e, t) {
                    ...
                    i.instances.push(g(n)),
                    n.element.dropzone = g(n);
                    var u = null != (a = i.optionsForElement(n.element)) ? a : {};
                    if (n.options = i.extend({}, s, u, null != t ? t : {}),
                ...
                return d(i, [{
                    ...
                    value: function() {
                        ...
                        this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(i.createElement('<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</button></div>"))),
                    ...
                    value: function() {
                        ...
                        return "FORM" !== this.element.tagName ? (t = i.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(r) : (this.element.setAttribute("enctype", "multipart/form-data"),
                    ...
                    key: "removeFile",
                    value: function(e) {
                        if (e.status === i.UPLOADING && this.cancelUpload(e),
                    ...
                    value: function(e, t, n, r, o) {
                        ...
                        return this.createThumbnail(e, t, n, r, !0, (function(t, n) {
                            ...
                            return "image/jpeg" !== r && "image/jpg" !== r || (u = k.restore(e.dataURL, u)),
                            o(i.dataURItoBlob(u))
                        }
                        ))
                    }
                    ...
                    value: function(e, t, n, r) {
                        ...
                        o) {
                            ...
                            e.dataURL = t,
                            this.createThumbnailFromUrl(e, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.thumbnailMethod, this.options.fixOrientation, a, r)
                        } else
                    ...
                    value: function(e) {
                        if (e.status === i.UPLOADING) {
                            ...
                            e.status !== i.ADDED && e.status !== i.QUEUED || (e.status = i.CANCELED,
                    ...
                    value: function(e) {
                        ...
                        this._transformFiles(e, (function(n) {
                            if (t.options.chunking) {
                                var r = n[0];
                                e[0].upload.chunked = t.options.chunking && (t.options.forceChunking || r.size > t.options.chunkSize),
                    ...
                    value: function(e, t) {
                        ...
                        for (var f in this.options.headers && i.extend(l, this.options.headers),
                        l) {
                            var p = l[f];
                    ...
                    value: function(e, t, n) {
                        ...
                        if (e[0].status !== i.CANCELED && 4 === t.readyState) {
                            if ("arraybuffer" !== t.responseType && "blob" !== t.responseType && (r = t.responseText,
